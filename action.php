  ...
  ';
   ...
   ';
    ...
    if ($_POST["action"] == "Create") {
        ...
        $statement = $connection->prepare(" INSERT INTO customers (first_name, last_name)
    ...
    if ($_POST["action"] == "Update") {
        ...
        $statement = $connection->prepare("UPDATE customers
    ...
    if ($_POST["action"] == "Delete") {
        $statement = $connection->prepare("DELETE FROM customers WHERE id = :id");
        $result = $statement->execute(array(
            ':id' => $_POST["id"]
        ));
        if (! empty($result)) {
